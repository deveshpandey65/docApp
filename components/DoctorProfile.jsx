...
const DoctorProfile = () => {
  const { doctor, isLoading, error, updateProfile, clearError } = useDoctorAuthStore();
  const { theme, toggleTheme } = useTheme();
  
  useEffect(() => {
    useDoctorAuthStore.getState().checkAuth();  // ✅ correct
  }, []);
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col items-center mb-6">
                  <div className={`w-32 h-32 rounded-full overflow-hidden mb-4 ${theme === 'dark' ? 'ring-2 ring-indigo-500' : 'ring-2 ring-blue-300'}`}>
                    <img 
                      src={avatarPreview || doctor.avatar || '/placeholder-avatar.png'} 
                      alt="Doctor Avatar" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {/* Specialization */}
                  <div>
                    <label className={`block ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} font-semibold mb-2`}>Specialization</label>
                    <input
                      type="text"
                      name="specialization"
                  ...
                  {/* Experience */}
                  <div>
                    <label className={`block ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} font-semibold mb-2`}>Experience (years)</label>
                    <input
                      type="number"
                      name="experience"
                  ...
                  {/* Degree */}
                  <div>
                    <label className={`block ${theme === 'dark' ? 'text-gray-300' : 'text-gray-700'} font-semibold mb-2`}>Degree</label>
                    <input
                      type="text"
                      name="degree"
              ...
              <div>
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className={`text-lg ${theme === 'dark' ? 'text-indigo-400' : 'text-blue-600'} mb-4`}>{doctor.specialization}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8">
                      ...
                      <div>
                        <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Experience</p>
                        <p className="font-medium">{doctor.experience} years</p>
                      </div>
                      <div>
                        <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-500'}`}>Degree</p>
                      ...
                      <div>
                        ...
                        <p className="font-medium">{doctor.gender && doctor.gender.charAt(0).toUpperCase() + doctor.gender.slice(1)}</p>
                      </div>
                    </div>
                  </div>
                </div>
