          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className={`${theme === 'dark' ? 'bg-blue-500 hover:bg-blue-600' : 'bg-blue-500 hover:bg-blue-600'} text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-300`}
